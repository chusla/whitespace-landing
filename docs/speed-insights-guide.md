...
### Add the Speed Insights integration to your app

The integration depends on your framework:
...
#### For JavaScript/Vanilla Applications
...
For Next.js 13.4 or older, create a dedicated component:
...
Then, import the component in your layout:
